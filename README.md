...
1. extra/WGestures 1.8.5.0.wgb 【增强体验】WGestures 用户可额外导入鼠标手势的配置
2. app.csv 配置文件
3. data.csv 配置文件
4. favicon.ico 图标文件
5. README.pdf 说明书
...
2. 鼠标侧边前进键 - 暂停音乐
3. 鼠标侧边后退键 - 下一曲
4. alt + left 或者借助 WGestures 手势 - 上一曲
5. alt + right 或者借助 WGestures 手势 - 下一曲
...
| 前进  | alt + 左 | 前进键 |
| 下个标签  | ctrl + tab | 用于切换标签 |
| 后退  | alt + 右 | 后退键 |
| 上个标签  | ctrl + shift + tab | 用于切换标签 |
| 鼠标侧边前进键 | xbutton2 | 万能后退键，在 QQ 音乐中用于下一曲 |
| 鼠标侧边后退键 | xbutton1 | 万能关闭键，在 QQ 音乐中用于暂停播放音乐 |
...
作者无力支撑，可能是 23 年最后的一个版本，需蛰伏很长时间。
