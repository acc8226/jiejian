...
| 鼠标侧边后退键(XB1) | 关闭窗口 | 关闭标签 | 关闭窗口 | 关闭窗口 | 下一曲 | 下一曲 |
...
| ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| Esc（逃逸键）| 无 | 关闭特定窗口 | - | - | - | - |
| Ctrl + F3 | ↓ | 打开/新建文件 | 新建标签 | 打开文件 或 无操作 | 打开文件 或 无操作 | - |
| Ctrl + F4 | ↑ | 关闭窗口 | 关闭标签 | 关闭窗口 | 关闭窗口 | - |
| Alt + ← | ← | 后退 | 后退 | 上一曲 | 快退 | 上一曲 |
| Ctrl + Shift + Tab | 上左 | Ctrl + Shift + Tab |切换上一个标签 | 上一曲 | 上一个视频 | 上一曲 |
