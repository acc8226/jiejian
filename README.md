...
调节音量大小：当鼠标移动到屏幕左边缘或任务栏上，可通过鼠标滑轮调节音量

![1](https://foruda.gitee.com/images/1689318820722473769/d4f9efe3_426858.gif)

## 2. 热键 之 重写快捷键

定义通用快捷键，支持 vscode、 idea 64 位、QQ、WindowsTerminal、Snipaste、SumatraPDF、wps、微信、google 等主流浏览器不同软件环境下使用。

* ctrl + f3 新建标签/窗口 避免和已有 ctrl + t 冲突
* ctrl + shift + tab 和 ctrl + tab 分别用于切换到上/下个标签 默认不用重写
* ctrl + f4 关闭标签/窗口
* ctrl + shift + t 撤销关闭标签 默认不用重写
...
参考 uTools，力争做一款简洁、精巧、高效实用的应用启动器。并长期维护更新,持续优化用户体验。
